...
function getVolunteerMessage(key) {
  ...
  const messages = {
    ...
    mk: {
      notLoggedIn:
        "Мора да сте најавени за да се регистрирате како волонтер. Ве молиме првин да се најавите.",
...
function showVolunteerInfo() {
  ...
  const translations = {
    ...
    mk: {
      ...
      description:
        "Придружете се на нашата волонтерска програма и станете дел од тимот посветен на создавање позитивни промени во локалните заедници.",
      whatYouWillDo: "Во кои активности ќе учествувате:",
      activities: [
        "Учествување во проекти за заедничка развојна акција",
        "Поддршка на иницијативи за заштита на животната средина",
        "Помош при програми за образование и работилници",
        "Помош при кампањи за заедничко подобрување на здравството",
        "Придонеси кон активности за зачувување на културната традиција",
        "Учествување во проекти за подобрување на инфраструктурата",
      ],
      benefits: "Придобивки од Волонтерството:",
      benefitsList: [
        "Стекнување на искуства и вештини",
        "Запознавање на слични луѓе и вмрежување",
        "Правење позитивни промени во вашата заедница",
        "Стекнување со знаење за одржлив развој",
        "Добивање обука и професионален развој",
        "Стекнување со сертификати и признанија",
      ],
      requirements: "Услови:",
      requirementsList: [
        "Минимална возраст: 16 години",
        "Желба за учење и соработка",
        "Флексибилна ангажираност (работни денови/викенди)",
